...
if ( is_multisite() /* && ! is_plugin_active_for_network( 'plugins/wp-document-revisions/wp-document-revisions.php' ) */ ) {
	...
	$wpdr_admin_url = network_admin_url( 'settings.php#document_settings' );
	$wpdr_admin_location = __( 'Network Admin &#x2192; Settings', 'wpdr-simple-downloads' );

} else {

	$wpdr_admin_url = admin_url( 'options-media.php' );
 ...
 * @since 1.0.0
 */
$wpdr_plugin_url = 'http://wordpress.org/extend/plugins/wp-document-revisions/';
				...
				<fieldset>
					...
					<label for="wpdr_upload_dir">
						<?php echo sprintf(
							...
							'<a href="' . esc_url_raw( $wpdr_plugin_url ) . '" target="_new">' . __( 'WP Document Revisions', 'wpdr-simple-downloads' ) . '</a>',
					...
					<fieldset>
						...
						<label for="wpdr_feed_privacy">
							<?php echo sprintf(
								...
								'<a href="' . $wpdr_plugin_url . '" target="_new">' . __( 'WP Document Revisions', 'wpdr-simple-downloads' ) . '</a>',
