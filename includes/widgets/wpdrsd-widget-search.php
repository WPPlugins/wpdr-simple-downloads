<?php
/**
 * WPDRSD: Search Downloads Widget.
 *
...
class DDW_WPDRSD_Search_Downloads_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		//$label_text       = ( isset( $instance[ 'label_text' ] ) ) ? esc_attr( $instance[ 'label_text' ] ) : null;
		//$placeholder_text = ( isset( $instance[ 'placeholder_text' ] ) ) ? esc_attr( $instance[ 'placeholder_text' ] ) : null;
		//$button_text      = ( isset( $instance[ 'button_text' ] ) ) ? esc_attr( $instance[ 'button_text' ] ) : null;
...
}  // end of widget class DDW_WPDRSD_Search_Downloads_Widget
